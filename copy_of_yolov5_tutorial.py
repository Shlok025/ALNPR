...
Original file is located at
    https://colab.research.google.com/drive/1jUG4LRXsQy3Tq96jNrltIsmX1otXSfs0
...
!python detect.py --weights /content/yolov5/runs/train/exp5/weights/best.pt --img 640 --conf 0.25 --source /content/yolov5/data/images
...
!python train.py --img 640 --batch 16 --epochs 50 --data /content/yolov5/data/custom_data.yaml --weights /content/yolov5/yolov5s.pt --cache

!wget https://github.com/ultralytics/yolov5/releases/download/v7.0/yolov5s.pt

"""# 4. Visualize"""

!rm -r /content/yolov5/train_data
